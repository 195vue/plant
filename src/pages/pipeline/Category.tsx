    ...
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="flex gap-3 flex-1 min-h-0">
        ...
        <DevNote
          id="pipeline-detail"
          title="管路详情面板"
          summary="展示当前管路基本信息/属性资料/图纸资料三个页签"
          items={[
            { label: "数据来源", value: "currentPipeline（当前筛选结果第一条或单管路选择）；属性资料由管路基础数据直接生成（规格/材质/壁厚/设计压力/设计温度/工作介质/安装日期），图纸资料按 关联对象类型=管路 且 关联对象ID=当前管路ID 查询" },
            { label: "交互逻辑", value: "头部显示管路用途/名称/编码；三个页签切换（基本信息/属性资料/图纸资料），切换页签保留管路，切换管路保留页签；「×」关闭显式选择后继续显示筛选结果第一条" },
